...
async function handleThinkBigChat(request, env, ctx) {
  ...
  // ── 繁簡後處理：強制移除簡體字殘留 ─────────────────────────────
  // 模型偶爾無視 prompt 指令使用簡體字，此處做最後一道確保
  const SIMP_TO_TRAD = {
    '我们': '我們', '你们': '你們', '他们': '他們', '她们': '她們', '它们': '它們',
    '产品': '產品', '导入': '導入', '企业': '企業', '发现': '發現', '进行': '進行',
    '现在': '現在', '使用': '使用', '简单': '簡單', '时间': '時間', '问题': '問題',
    '这个': '這個', '那个': '那個', '什么': '什麼', '没有': '沒有', '已经': '已經',
    '可以': '可以', '谢谢': '謝謝', '需要': '需要', '服务': '服務', '工作': '工作',
    '公司': '公司', '帮助': '幫助', '实现': '實現', '团队': '團隊', '联系': '聯繫',
    '专注': '專注', '专业': '專業', '关于': '關於', '还是': '還是', '里面': '裡面',
  };
